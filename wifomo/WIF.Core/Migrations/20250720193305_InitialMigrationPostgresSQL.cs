...
{
    /// <inheritdoc />
    public partial class InitialMigrationPostgresSQL : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    uid = table.Column<Guid>(type: "uuid", nullable: true, defaultValueSql: "gen_random_uuid()"),
                    user_uid = table.Column<Guid>(type: "uuid", nullable: true),
                    account = table.Column<string>(type: "text", nullable: true),
                    category = table.Column<string>(type: "text", nullable: true),
                    currency = table.Column<string>(type: "text", nullable: true),
                    amount = table.Column<double>(type: "double precision", nullable: true),
                    ref_currency_amount = table.Column<double>(type: "double precision", nullable: true),
                    type = table.Column<string>(type: "text", nullable: true),
                    payment_type = table.Column<string>(type: "text", nullable: true),
                    payment_type_local = table.Column<string>(type: "text", nullable: true),
                    ...
                    transfer = table.Column<bool>(type: "boolean", nullable: true),
                    ...
                    custom_category = table.Column<bool>(type: "boolean", nullable: true),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "now()"),
                    created_by_user_uid = table.Column<Guid>(type: "uuid", nullable: true),
